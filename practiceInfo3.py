...
csv_filename = "formula1_race_practice3.csv"
...
def makecsv(data, race_name, y):
    ...
    csv_filename = f"formula1_results_practice3_{y}.csv"
...
def main(race_links, race_name, y, event_indices):
    ...
    if race_name == "all":
        for index in range(1, len(race_links)):
            ...
            if index in event_indices.get('practice-3', []):
                try:
                ...
                print("\n" + race_name + " does not have practice 3")
